...
public class Main extends JFrame {
        ...
        public Main() {
                ...
                getContentPane().setBackground(new Color(0, 183, 253));
                ...
                guessPanel.setBackground(new Color(63, 63, 63));
                for (int i = 0; i < 4; i++) {
                ...
                submitButton.setBackground(new Color(253, 180, 0));
...
//created by merna ,eman and retaj^^